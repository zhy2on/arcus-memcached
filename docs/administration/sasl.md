...
| - | - | - |
| [`get`](../ascii-protocol/ch04-command-key-value.md#retrieval), [`gets`](../ascii-protocol/ch04-command-key-value.md#retrieval), [`mget`](../ascii-protocol/ch04-command-key-value.md#retrieval), [`mgets`](../ascii-protocol/ch04-command-key-value.md#retrieval), [`add`](../ascii-protocol/ch04-command-key-value.md#storage), [`set`](../ascii-protocol/ch04-command-key-value.md#storage), [`replace`](../ascii-protocol/ch04-command-key-value.md#storage), [`append`](../ascii-protocol/ch04-command-key-value.md#storage), [`prepend`](../ascii-protocol/ch04-command-key-value.md#storage), [`cas`](../ascii-protocol/ch04-command-key-value.md#storage), [`incr`](../ascii-protocol/ch04-command-key-value.md#increment-decrement), [`decr`](../ascii-protocol/ch04-command-key-value.md#increment-decrement), [`delete`](../ascii-protocol/ch04-command-key-value.md#deletion) | Key-Value 데이터 조작 명령 | `kv` |
...
| `version`, `ready`, `quit`, [`help`](../ascii-protocol/ch13-command-administration.md#help), [`stats`](../ascii-protocol/ch13-command-administration.md#stats), [`sasl`](../ascii-protocol/ch12-command-sasl.md) | 권한 없이 수행가능한 명령 | 없음 |
